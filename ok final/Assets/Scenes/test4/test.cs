...
namespace OpenCVForUnityExample
{
    ...
    public class test : MonoBehaviour
    {
        ...
        protected virtual void Start()
        {
            ...
            {
                input_filepath = Utils.getFilePath("dnn/imgTest/" + input+".jpg");
        ...
        protected virtual void Run()
        {
            ...
            else
            {
                ...
                Mat blob = Dnn.blobFromImage(img, scale, inpSize, mean, true, false);
