...
namespace OpenCVForUnityExample
{
    ...
    public class test3 : MonoBehaviour
    {
        ...
        /// <custom variables>
        protected List<string> classNames = System.IO.File.ReadLines(Utils.getFilePath("dnn/yolo.names")).ToList();
        ...
        void Update()
        {
            if (webCamTextureToMatHelper.IsPlaying() && webCamTextureToMatHelper.DidUpdateThisFrame())
            {
                ...
                else
                {
                    ...
                    try
                    {
                        postprocess(img, outs, net, Dnn.DNN_BACKEND_INFERENCE_ENGINE);
        ...
        protected virtual void postprocess(Mat frame, List<Mat> outs, Net net, int backend = Dnn.DNN_BACKEND_INFERENCE_ENGINE)
        {
        ...
        protected virtual void drawPred(int classId, float conf, double left, double top, double right, double bottom, Mat frame)
        {
            ...
            Imgproc.putText(frame, label, new Point(left , top - 20), Imgproc.FONT_HERSHEY_SIMPLEX, 1, new Scalar(0, 255, 0, 255), 3);
